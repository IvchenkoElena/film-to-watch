...
public interface FilmStorage {
    ...
    List<Film> searchFilmsByDirector(String searchQuery);

    List<Film> searchFilmsByTitle(String searchQuery);

    List<Film> searchFilmsByAllCriteria(String searchQuery);
}
